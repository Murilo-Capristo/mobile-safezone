...
export default function HomeScreen() {
  ...
  const loadAlertas = async (pageNumber: number, replace = false) => {
    if (!usuario) return;
    setLoading(true);
    setAuthError(false);
    try {
  ...
  useEffect(() => {
    loadAlertas(page, page === 0);
  }, [page]);

  function corDoAlerta(alerta: string): string {
    switch (alerta) {
      case "Estresse térmico alto": return "#e63946";
      case "Ambiente muito seco e quente": return "#f4a261";
      case "Risco de geada": return "#457b9d";
      case "Risco de fungos e doenças": return "#2a9d8f";
      case "Temperatura muito alta": return "#d90429";
      case "Risco de queimada": return "#e76f51";
      case "Umidade muito baixa": return "#f4a261";
      case "Congelamento possível": return "#73a3e6";
      default: return "#000";
    }
  }
